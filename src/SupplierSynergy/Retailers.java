...
public class Retailers extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        tbl.setLIMIT(100);
        tbl.setSQLQuery("SELECT * FROM Retailer");
        jScrollPane1.setViewportView(tbl);

        add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 140, 1200, 540));
        ...
        add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 680, 1200, 80));
    ...
    private void btn_addActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_addActionPerformed
        // TODO add your handling code here:
        new SupplierSynergy.AddItems.AddRetailer().setVisible(true);
